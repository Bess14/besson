...
number = int(input("Пожалуйста, введите число от 0 до 10: "))
...
x = int(input("Пожалуйста, введите число x: "))
y = int(input("Пожалуйста, введите число y: "))

x, y = y, x
print("Меняем значения переменных!")
print("x =", x, "Y=", y)
